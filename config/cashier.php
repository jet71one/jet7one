...
if(env('STRIPE_MODE') == 'test'){
    ...
    $cashier_stripe_key = env('STRIPE_TEST_KEY');
    $cashier_stripe_secret = env('STRIPE_TEST_SECRET');

} else {

    $cashier_stripe_key = env('STRIPE_LIVE_KEY');
    $cashier_stripe_secret = env('STRIPE_LIVE_SECRET');
...
return [
    ...
    */
    ...
    'key' => $cashier_stripe_key,

    'secret' => $cashier_stripe_secret,
