    ...
    <div class="container">
        <div class="news__inner">
            <div class="news__item">
                <img src="images/news-1.jpg" alt="News " class="news-img">
                <div class="news__content">
                    <a href="#">
                        <h3 class="news__title">Kiev-Pechersk Lavra</h3>
                        <p class="news__text">Kiev-Pechersk Lavra is perhaps one of the most famous and popular sights of Kiev. Both residents of the capital and its guests, both pilg..</p>
