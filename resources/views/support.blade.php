...
<div class="communications">
    <div class="communication__inner" style="background: linear-gradient(135deg,#ec5e87 20%,#2a70de 70%);">
        <div class="communication__item" >
            ...
            <h3 class="communication__item-title ">Pass guide registration</h3>
             <p class="communication__item-desc">You are local guide in your region or you want to be Jet7one local guide.</p>
            <h2 class="communication__item-title "style="font-size:16px !important"></h2>
            
            <a href="/register" class="btn btn-white">select your Plan</a>
        </div>
        <div class="communication__item">
            <div class="communicate__item-img">
            ...
            <p class="communication__item-desc">Got any questions? Contact us via online chat</p>
            <a href="viber://chat?number=%2B380669213266" class="btn btn-white">open chat</a>
        </div>
        <div class="communication__item" >
            <div class="communicate__item-img">
            ...
            <h3 class="communication__item-title ">call or write us</h3>
